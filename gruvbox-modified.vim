...
" Modified colors
let s:gb.highlight_cyan 	  = ['#00ffd7', 50]       " 0-255-255
let s:gb.light_slate_grey 	= ['#8787af', 103]      " 215-215-255
...
call s:HL('Search',    s:bg0, s:highlight, s:inverse)
