...
call s:HL('StorageClass', s:palette.gray16, s:palette.black , 'none')
call s:HL('Structure', s:palette.white, s:palette.black , 'none')

" FLOW CONTROL
call s:HL('Statement', s:palette.gray16, s:palette.black , 'none')
call s:HL('Conditional', s:palette.gray16, s:palette.black , 'none')
call s:HL('Repeat', s:palette.gray16, s:palette.black , 'none')
call s:HL('Label', s:palette.gray16, s:palette.black , 'none')
call s:HL('Exception', s:palette.gray16, s:palette.black , 'none')
