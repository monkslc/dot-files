...
let s:palette.orange 	 = [202, "#ff5f00"]
let s:palette.orange2 	 = [209, "#ff875f"]
let s:palette.pink 	 = [198, "#ff0087"]
let s:palette.pink2 	 = [212, "#ff87d7"]
...
" PRIMITIVES
call s:HL('Boolean', s:palette.orange2, s:palette.black , 'none')
call s:HL('Character', s:palette.orange2, s:palette.black , 'none')
call s:HL('Constant', s:palette.orange2, s:palette.black , 'none')
call s:HL('Float', s:palette.orange2, s:palette.black , 'none')
call s:HL('Number', s:palette.orange2, s:palette.black , 'none')
call s:HL('String', s:palette.orange2, s:palette.black , 'bold')
call s:HL('SpecialChar', s:palette.orange2, s:palette.black , 'none')
...
" BINDINGS
call s:HL('Identifier', s:palette.orange, s:palette.black, 'none')
call s:HL('Function', s:palette.orange, s:palette.black, 'none')
call s:HL('Keyword', s:palette.orange, s:palette.black, 'none')
call s:HL('Operator', s:palette.white, s:palette.black, 'none')

" TYPES
call s:HL('Type', s:palette.pink2, s:palette.black , 'none')
call s:HL('Typedef', s:palette.pink2, s:palette.black , 'none')
call s:HL('StorageClass', s:palette.pink2, s:palette.black , 'none')
call s:HL('Structure', s:palette.pink2, s:palette.black , 'none')

" FLOW CONTROL
call s:HL('Statement', s:palette.pink, s:palette.black , 'none')
call s:HL('Conditional', s:palette.pink, s:palette.black , 'none')
call s:HL('Repeat', s:palette.pink, s:palette.black , 'none')
call s:HL('Label', s:palette.pink, s:palette.black , 'none')
call s:HL('Exception', s:palette.pink, s:palette.black , 'none')
